...
obj/__user_mlfq_test.out:     file format elf32-i386
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800049:	c7 04 24 c0 11 80 00 	movl   $0x8011c0,(%esp)
  ...
  800062:	e8 7e 00 00 00       	call   8000e5 <vcprintf>
    cprintf("\n");
  800067:	c7 04 24 da 11 80 00 	movl   $0x8011da,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800099:	c7 04 24 dc 11 80 00 	movl   $0x8011dc,(%esp)
  ...
  8000b2:	e8 2e 00 00 00       	call   8000e5 <vcprintf>
    cprintf("\n");
  8000b7:	c7 04 24 da 11 80 00 	movl   $0x8011da,(%esp)
...
exit(int error_code) {
  ...
  8002e6:	c7 04 24 f8 11 80 00 	movl   $0x8011f8,(%esp)
...
umain(void) {
  ...
  800394:	83 ec 28             	sub    $0x28,%esp
    int ret = main();
  800397:	e8 30 0d 00 00       	call   8010cc <main>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  8004b8:	05 24 13 80 00       	add    $0x801324,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800607:	8b 04 85 48 13 80 00 	mov    0x801348(,%eax,4),%eax
  ...
  800712:	c7 44 24 08 3e 13 80 	movl   $0x80133e,0x8(%esp)
  800719:	00 
  ...
  80073e:	75 05                	jne    800745 <vprintfmt+0x1ad>
                p = "(null)";
  800740:	be 41 13 80 00       	mov    $0x801341,%esi
            }
            if (width > 0 && padc != '-') {
...
void cpu_bound_task(int id) {
  ...
  800fe3:	83 ec 28             	sub    $0x28,%esp
    int i, j;
    int x = 0;
  800fe6:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
    cprintf("Process %d (CPU-Bound) started.\n", id);
  800fed:	8b 45 08             	mov    0x8(%ebp),%eax
  800ff0:	89 44 24 04          	mov    %eax,0x4(%esp)
  800ff4:	c7 04 24 a0 14 80 00 	movl   $0x8014a0,(%esp)
  800ffb:	e8 18 f1 ff ff       	call   800118 <cprintf>
    for (i = 0; i < 10; i++) {
  801000:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801007:	eb 3e                	jmp    801047 <cpu_bound_task+0x67>
        /* 大量计算 */
        for (j = 0; j < 5000000; j++) {
  801009:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  801010:	eb 0e                	jmp    801020 <cpu_bound_task+0x40>
            x = x + j * i;
  801012:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801015:	0f af 45 f4          	imul   -0xc(%ebp),%eax
  801019:	01 45 ec             	add    %eax,-0x14(%ebp)
    int i, j;
    int x = 0;
    cprintf("Process %d (CPU-Bound) started.\n", id);
    for (i = 0; i < 10; i++) {
        /* 大量计算 */
        for (j = 0; j < 5000000; j++) {
  80101c:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
  801020:	81 7d f0 3f 4b 4c 00 	cmpl   $0x4c4b3f,-0x10(%ebp)
  801027:	7e e9                	jle    801012 <cpu_bound_task+0x32>
            x = x + j * i;
        }
  ...
  801037:	c7 04 24 c4 14 80 00 	movl   $0x8014c4,(%esp)
  80103e:	e8 d5 f0 ff ff       	call   800118 <cprintf>
/* 模拟 CPU 密集型任务 */
void cpu_bound_task(int id) {
    int i, j;
    int x = 0;
    cprintf("Process %d (CPU-Bound) started.\n", id);
    for (i = 0; i < 10; i++) {
  801043:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801047:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
  80104b:	7e bc                	jle    801009 <cpu_bound_task+0x29>
        for (j = 0; j < 5000000; j++) {
            x = x + j * i;
        }
        cprintf("CPU Process %d: Computed phase %d\n", id, i);
  ...
  801054:	c7 04 24 e7 14 80 00 	movl   $0x8014e7,(%esp)
  80105b:	e8 b8 f0 ff ff       	call   800118 <cprintf>
}
  801060:	c9                   	leave  
  801061:	c3                   	ret    

00801062 <io_bound_task>:
...
void io_bound_task(int id) {
  ...
  80106f:	c7 04 24 00 15 80 00 	movl   $0x801500,(%esp)
  801076:	e8 9d f0 ff ff       	call   800118 <cprintf>
    for (i = 0; i < 20; i++) {
  80107b:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801082:	eb 2d                	jmp    8010b1 <io_bound_task+0x4f>
        /* 模拟 IO 等待 (在 uCore 中 yield 可以模拟放弃 CPU) */
        if (i % 2 == 0) {
  801084:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801087:	83 e0 01             	and    $0x1,%eax
  80108a:	85 c0                	test   %eax,%eax
  80108c:	75 1a                	jne    8010a8 <io_bound_task+0x46>
  ...
  80109c:	c7 04 24 20 15 80 00 	movl   $0x801520,(%esp)
  8010a3:	e8 70 f0 ff ff       	call   800118 <cprintf>
        }
        yield(); /* 主动放弃 CPU */
  8010a8:	e8 8a f2 ff ff       	call   800337 <yield>
...
void io_bound_task(int id) {
    ...
    cprintf("Process %d (IO-Bound) started.\n", id);
    for (i = 0; i < 20; i++) {
  8010ad:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  8010b1:	83 7d f4 13          	cmpl   $0x13,-0xc(%ebp)
  8010b5:	7e cd                	jle    801084 <io_bound_task+0x22>
        if (i % 2 == 0) {
            cprintf("IO Process %d: Waiting for IO (Yield) phase %d\n", id, i);
        }
        yield(); /* 主动放弃 CPU */
  ...
  8010ba:	89 44 24 04          	mov    %eax,0x4(%esp)
  8010be:	c7 04 24 e7 14 80 00 	movl   $0x8014e7,(%esp)
  8010c5:	e8 4e f0 ff ff       	call   800118 <cprintf>
}
  8010ca:	c9                   	leave  
  8010cb:	c3                   	ret    
...
int main(void) {
  ...
  8010cf:	83 e4 f0             	and    $0xfffffff0,%esp
  8010d2:	83 ec 20             	sub    $0x20,%esp
    int pid1, pid2, pid3;

    cprintf("MLFQ Test: Starting Mixed Workload...\n");
  8010d5:	c7 04 24 50 15 80 00 	movl   $0x801550,(%esp)
  8010dc:	e8 37 f0 ff ff       	call   800118 <cprintf>

    if ((pid1 = fork()) == 0) {
  8010e1:	e8 0e f2 ff ff       	call   8002f4 <fork>
  8010e6:	89 44 24 1c          	mov    %eax,0x1c(%esp)
  8010ea:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  8010ef:	75 18                	jne    801109 <main+0x3d>
        cpu_bound_task(1); /* 子进程 1: CPU */
  8010f1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  8010f8:	e8 e3 fe ff ff       	call   800fe0 <cpu_bound_task>
        exit(0);
  8010fd:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801104:	e8 cc f1 ff ff       	call   8002d5 <exit>
    }

    if ((pid2 = fork()) == 0) {
  801109:	e8 e6 f1 ff ff       	call   8002f4 <fork>
  80110e:	89 44 24 18          	mov    %eax,0x18(%esp)
  801112:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801117:	75 18                	jne    801131 <main+0x65>
        io_bound_task(2);  /* 子进程 2: IO */
  801119:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  801120:	e8 3d ff ff ff       	call   801062 <io_bound_task>
        exit(0);
  801125:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  80112c:	e8 a4 f1 ff ff       	call   8002d5 <exit>
    }

    if ((pid3 = fork()) == 0) {
  801131:	e8 be f1 ff ff       	call   8002f4 <fork>
  801136:	89 44 24 14          	mov    %eax,0x14(%esp)
  80113a:	83 7c 24 14 00       	cmpl   $0x0,0x14(%esp)
  80113f:	75 18                	jne    801159 <main+0x8d>
        cpu_bound_task(3); /* 子进程 3: CPU (干扰项) */
  801141:	c7 04 24 03 00 00 00 	movl   $0x3,(%esp)
  801148:	e8 93 fe ff ff       	call   800fe0 <cpu_bound_task>
        exit(0);
  80114d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801154:	e8 7c f1 ff ff       	call   8002d5 <exit>
    }

    /* 等待所有子进程结束 */
    waitpid(pid1, NULL);
  801159:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801160:	00 
  801161:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801165:	89 04 24             	mov    %eax,(%esp)
  801168:	e8 b0 f1 ff ff       	call   80031d <waitpid>
    waitpid(pid2, NULL);
  80116d:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801174:	00 
  801175:	8b 44 24 18          	mov    0x18(%esp),%eax
  801179:	89 04 24             	mov    %eax,(%esp)
  80117c:	e8 9c f1 ff ff       	call   80031d <waitpid>
    waitpid(pid3, NULL);
  801181:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801188:	00 
  801189:	8b 44 24 14          	mov    0x14(%esp),%eax
  80118d:	89 04 24             	mov    %eax,(%esp)
  801190:	e8 88 f1 ff ff       	call   80031d <waitpid>

    cprintf("MLFQ Test: All Finished.\n");
  801195:	c7 04 24 77 15 80 00 	movl   $0x801577,(%esp)
  80119c:	e8 77 ef ff ff       	call   800118 <cprintf>
    return 0;
